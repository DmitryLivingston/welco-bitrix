								...
								<div class="col-6">
									<div class="d-flex justify-content-center">
										<div class="modal_menu_text">
											<h3><a href="#feedback" onClick="$('.modal').modal('hide');" id="modalMenuWhy">Зачем нужны пребиотики?</a></h3>
											<h3><a data-bs-dismiss="modal" href="#first_product_couple">Продукты</a></h3>
											<h3><a data-bs-dismiss="modal" href="#answers">Ответы на вопросы</a></h3>
											<h3><a data-bs-dismiss="modal" href="#how_use">Как применять</a></h3>
											<h3><a data-bs-dismiss="modal" href="#where_bay">Где купить Welco</a></h3>
										</div>
									</div>
								</div>
							</div>
